...
<% HttpSession hs=request.getSession(); String uname="User" ; if((String)hs.getAttribute("uname")!=null) {
   uname=(String)hs.getAttribute("uname"); } int uid1=0; if((Integer)hs.getAttribute("uid")!=null) {
   uid1=((Integer)hs.getAttribute("uid")).intValue(); } %>

   <body bgcolor="#559ED9" alink="white" vlink="white" link="white">

      <div style="position:absolute; left:130px ;top:30px "><br>
         <font face="verdana" color="black" size="5px"><b>&nbsp;&nbsp;&nbsp;WFBComplaintManagementSystem</b></font>
      </div>
      <table width="100%" border=0 cellpadding="3">
         <tr>
            ...
            <td align="right" valign="bottom">
               ...
               <b>
                  <%if(uname.equals("admin")){%>Welcome,&nbsp;&nbsp; Admin<%} else{%>Welcome,&nbsp;&nbsp;<%=uname%>
                           <%} %>
               </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <b>[ <%if(uname.equals("admin")){%><a href="./AdminHome.jsp">
                        <%} else if(uname.equals("User")){%><a href="./Home.jsp">
                              <%} else{%><a href="./UserHome.jsp?uid=<%=uid1%>&uname=<%=uname%>">
                                    <%} %>
                                       <font color="#FBC61">home</font>
                                 </a> ]</b>&nbsp;
               <%if(uname!="User"){%><b>[ <a href="./logout.jsp">
                        <font color="#FBC61" size="3px">logout</font>
                     </a> ]</b>
                  <%} %>
            </td>
